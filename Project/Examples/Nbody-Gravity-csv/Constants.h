...
// #define NUM_BODIES (64000) // Number of small particles
...
#define RENDER_INTERVAL 100 // How many timesteps to simulate in between each frame rendered
...
std::ostream &operator << (std::ostream &out, const body &b) {
	out << "pos: " << b.position << std::endl;
	out << "vec: " << b.velocity << std::endl;
	out << "acc: " << b.accel << std::endl;
	out << "mas: " << b.mass;
